...
echo "$($PSQL "SELECT DISTINCT name FROM games JOIN teams ON games.winner_id=teams.team_id OR games.opponent_id=teams.team_id WHERE name LIKE 'Co%' ORDER BY name")"
